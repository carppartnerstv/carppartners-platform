...
// CSS Grid ya iguala la altura de las dos tarjetas de una fila por defecto
// (align-items: stretch) — lo que NO hacía solo, y por eso se veía hueco en
// blanco debajo de una lista corta, es que el CONTENIDO de dentro (la
// lista) rellenara esa altura ya igualada. flex-col + flex-1 en la lista
